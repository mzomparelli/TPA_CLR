...
Public Structure SpreadEx
    ...
    Public Sub Accumulate(ByVal value As SqlString, ByVal Quantifier As SqlString, displayStyle As String)
    ...
    Public Sub Merge(ByVal group As SpreadEx)
